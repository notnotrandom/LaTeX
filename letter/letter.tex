...
% date field may include location if senderaddr is empty:
% \setvar{date}{Looneytoon Land, February 29, 2016}
...
% senderaddr can be empty or commented out (cf. comment on \setvar{date} above).
\setvar{senderaddr}{Acme Street n.\ 69\\Daffy's Diggs\\Looneytoon Land, 1234}
